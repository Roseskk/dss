...
const MobileMenu: React.FC = () => {
    ...
    return(
        <section className={`section-mobile-menu ${isOpenMobile ? 'section-mobile-menu__visible' : ''}`}>
            ...
            <span>info@dssystem.ru</span>
            <div className={'mobile-contacts-icon'}>
                <Link to={'#'}>
                    <svg width="50" height="50" viewBox="0 0 36 36" fill="white" xmlns="http://www.w3.org/2000/svg">
                ...
                <Link to={'#'}>
                    <svg width="50" height="50" viewBox="0 0 37 36" fill="none" xmlns="http://www.w3.org/2000/svg">
